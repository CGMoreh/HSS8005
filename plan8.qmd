...
contents <- tibble(
  ...
  Topic = c("Introduction", paste("{{< ", paste0("var topic.w", 1:8), " >}}"), "Conclusion"),
  Info = c(NA, paste0("./materials/notes/info_w", 1:8), NA),
  Notes = c(NA, paste0("./materials/notes/notes_w", 1:8), NA),
  Lecture = c(NA, paste0("./materials/slides/slides_w", 1:8), NA),
  Labs = c(NA, paste0("./materials/worksheets/lab_w", 1:8), NA),
  Handouts = c(NA, paste0("./materials/handouts/sheet_w", 1:8), NA),
  )
