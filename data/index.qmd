...
The datasets can be downloaded by clicking on the file name, or read into `R` directly from `"https://cgmoreh.github.io/HSS8005/data/___"` (using a type-appropriate read function and replacing \_\_\_ with "File name" and "Type" extension; e.g. `haven::read_dta("https://cgmoreh.github.io/HSS8005/data/dataset.dta")`).
