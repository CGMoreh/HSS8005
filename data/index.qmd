...
[{{< fa download size=sm >}} Download .dta](/data/osterman_t3.dta){.btn .btn-ncl}
[{{< fa code >}} Data wrangling code (`.R`)](/data/osterman_t3_data_prep.R){.btn .link-secondary} 
:::
...
[{{< fa code >}} Data wrangling code (`.R`)](/data/delhey&newton2003_data_prep.R){.btn .link-secondary} 
...
::: {.callout-note icon="false" collapse="true"}
## {{< fa solid database >}} **Mitchell, 2021**

This dataset is the one underpinning the analysis carried out by @Mitchell2021SocialTrustAntiimmigrant. The article uses the European Social Survey (2002–2016) to test how differences in social trust, both within and between countries influence attitudes about immigrants. 

[{{< fa download size=sm >}} Download .dta](/data/mitchell2021.rds){.btn .btn-ncl}
